...
HelpPopup::HelpPopup()
{
    ...
    note("MOVEMENT: enable / disable recorded path; edit keyframes (Snap times: dropdown");
    note("rounds times to 0.5 / 1 / 2 / 5 s for easier authoring); pick playback mode");
    note("(Natural / Loop / Pingpong) and movement duration.");
